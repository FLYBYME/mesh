...
import type { IMeshNetworkNode } from '../types/mesh.types';
...
import type { IMeshNetwork, ILogger, IServiceRegistry, IMeshPacket, IMeshNetworkSubscriptionHandler } from '../interfaces';
